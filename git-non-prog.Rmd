---
title: "Version Control with the GitHub App and GitHub<sup>1</sup>"
author: "Akash Shaji"
subtitle: "Research Transparency and Reproducibility Training (RT2)"
date: "20 May 2026 | May 19–21, 2026 | Berkeley, CA <br><br> <sup>1</sup>*adapted from Fernando Hoces de la Guardia*"
output: 
  xaringan::moon_reader:
    footer: "Research Transparency and Reproducibility Training (RT2) 2026"
...
Refer to this [document](https://tinyurl.com/setup-git) for instructions.
Link: tinyurl.com/setup-git
]
...
- Git is a type of VCS and GitHub is a company that builds on top of it.
...
- Github is a company that provides two services (that we care of): 
  - A web hosting service for all our files tracked with Git (public and private repos are free).
...
2. Begin working from the last saved version (eg: `20180325demo_AS.do`).  
3. At the end of the day, save on a new version (eg: `20180327demo_AS.do`).  
...
<div style="display: inline-block; text-align: center; position: relative; width: 90%; height: 420px;">

<!-- Remote repo -->
<div style="position: absolute; top: 0px; left: 50%; transform: translateX(-50%); background: #d0e1f9; border: 2px solid #4a6fa5; border-radius: 10px; padding: 15px 40px; font-size: 1.2em; font-weight: bold;">
GitHub (Remote)
</div>

<!-- Your Local repo -->
<div style="position: absolute; top: 190px; left: 12%; background: #d0e1f9; border: 2px solid #4a6fa5; border-radius: 10px; padding: 15px 30px; font-size: 1.1em; font-weight: bold;">
Your Local Repo
</div>

<!-- Collaborator Local repo -->
<div style="position: absolute; top: 190px; right: 12%; background: #d0e1f9; border: 2px solid #4a6fa5; border-radius: 10px; padding: 15px 30px; font-size: 1.1em; font-weight: bold;">
Collaborator's Repo
</div>

<!-- Working files -->
<div style="position: absolute; top: 350px; left: 12%; background: #e8e8e8; border: 2px solid #888; border-radius: 8px; padding: 12px 25px; font-size: 1em;">
Your Working Files
</div>

<!-- Arrows and labels -->
<div style="position: absolute; top: 80px; left: 28%; font-size: 1.1em; color: #2a7f2a; font-weight: bold;">&#x2191; push</div>
<div style="position: absolute; top: 130px; left: 38%; font-size: 1.1em; color: #c0392b; font-weight: bold;">&#x2193; pull</div>
<div style="position: absolute; top: 80px; right: 28%; font-size: 1.1em; color: #c0392b; font-weight: bold;">pull &#x2193;</div>
<div style="position: absolute; top: 130px; right: 38%; font-size: 1.1em; color: #2a7f2a; font-weight: bold;">push &#x2191;</div>
<div style="position: absolute; top: 300px; left: 17%; font-size: 1.1em; color: #7d3c98; font-weight: bold;">&#x2191; commit</div>
...
---
# .font80[Demo #2: Branches and collaboration (we will be here a while)]
<br>
.font140[
...
---
# Demo #3: .font80[Look inside a real-life project (and collaborate!)]
.font140[
...
3 - Explore a real life repo.
    *Review: All of the above, plus: how does a real-life example look like.*
]
...
---
# .font80[Researchers Doing Highly Reproducible Work<sup>1</sup>] 
